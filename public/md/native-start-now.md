...
import { NativeStartNow } from "@/components/native/shadcnui/native-delete-shadcnui.tsx"
...
<ComponentSource name="native-start-now" title="@/components/native/shadcnui/native-delete-shadcnui.tsx" />
...
- **Category**: native
- **Tags**: button, start, sparkle, animation, loading, gradient, native
