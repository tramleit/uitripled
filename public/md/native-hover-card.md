...
<ComponentSource name="native-hover-card" title="components/native/shadcnui/native-hover-card-shadcnui.tsx" />
...
- **Category**: native
- **Tags**: hover, card, avatar, profile, expand, animation, native
