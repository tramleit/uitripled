...
import { NativeLiquidButton } from "@/components/native/shadcnui/native-morphing-button-shadcnui.tsx"
...
<ComponentSource name="native-liquid-button" title="@/components/native/shadcnui/native-morphing-button-shadcnui.tsx" />
...
- **Category**: native
- **Tags**: button, liquid, progress, animation, loading, native, interactive
