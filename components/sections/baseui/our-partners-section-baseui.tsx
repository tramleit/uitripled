...
export function OurPartnersSectionBaseui() {
        ...
        >
          {partners.map((partner) => (
            <motion.div key={partner.name} variants={itemVariants}>
              <div className="group flex h-32 items-center justify-center rounded-lg border-2 border-border bg-background text-card-foreground shadow-sm transition-all hover:border-primary hover:shadow-lg">
